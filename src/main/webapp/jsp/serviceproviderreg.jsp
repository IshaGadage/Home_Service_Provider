...
<body>
  ...
  <section class="contact_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <form action="serviceprovider_insert">
            ...
            <div>
              <input type="text" placeholder="Phone Number" name="phoneno" style="color:black;">
            </div>
            <div>
    ...
    <select id="options" name="service">
        ...
        <option value="Plumbing">Plumbing</option> 
             ...
             <div>
              <input type="text" placeholder="Price" name="price" style="color:black; ;">
            </div>
             <div>
              <input type="text" placeholder="Description" name="description" style="color:black; height: 122px ;">
            </div>
           				<%
