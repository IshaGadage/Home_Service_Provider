...
<%@page import="com.example.demo.bean.user_register"%>
...
<body>
    <div class="admin-container">
        ...
        <%@include file="admin_header.jsp" %>
				...
				<% ArrayList<user_register> list = (ArrayList) session.getAttribute("userlist"); %>
                ...
                <table class="table">
                    ...
                    <% for(user_register s : list){ %>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <form action="delete_users">
                                <input type="hidden" name="u_id" value="<%= s.getU_id()%>">
