        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              ...
              <p>
 At we are committed to providing top-quality repair and maintenance services to homes and businesses alike. 
 With over [X] years of experience in the industry, we have built a reputation for reliability, professionalism, and excellence. 
 Our team of certified technicians is dedicated to delivering the highest standard of service, ensuring that your equipment and 
 systems are running smoothly and efficiently.        </p>
              <a href="contact">
                Contact Us
              </a>
            </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
Whether it’s repairing appliances, maintaining HVAC systems, fixing plumbing issues, or handling electrical repairs, we have the expertise to handle a wide range of tasks. 
Our goal is to offer cost-effective solutions tailored to your specific needs, keeping your home or business running without a hitch.            </p>
            <a href="">
              Read More
            </a>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
We believe in transparent pricing, punctual service, and a customer-first approach. Our team is always ready to tackle any 
repair or maintenance challenge, with a focus on safety, quality, and minimal disruption to your daily routine.            </p>
            <a href="">
              Read More
            </a>
          </div>
  ...
  <section class="client_section ">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <h5>At INANCE, we take great pride in providing exceptional repair and maintenance services. 
        But don’t just take our word for it—hear from some of our satisfied clients:</h5>
      </div>
